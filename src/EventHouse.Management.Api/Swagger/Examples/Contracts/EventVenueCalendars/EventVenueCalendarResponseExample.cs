...
internal sealed class EventVenueCalendarResponseExample : IExamplesProvider<EventVenueCalendarResponse>
{
    public EventVenueCalendarResponse GetExamples() => EventVenueCalendarExampleData.Result();
}
