...
public sealed class CreateVenueValidatorTests : ValidatorTestBase<CreateVenueCommand>
{
    public CreateVenueValidatorTests() : base(new CreateVenueCommandValidator()) { }
