...
public sealed class SetArtistGenreStatusValidatorTests : ValidatorTestBase<SetArtistGenreStatusCommand>
{
    public SetArtistGenreStatusValidatorTests() : base(new SetArtistGenreStatusCommandValidator()) { }
    ...
    private static SetArtistGenreStatusCommand CreateValidCommand() =>
        new(
